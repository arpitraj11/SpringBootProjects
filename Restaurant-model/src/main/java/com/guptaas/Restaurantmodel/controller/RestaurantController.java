package com.guptaas.Restaurantmodel.controller;

import com.guptaas.Restaurantmodel.Service.RestaurantService;
...
public class RestaurantController {
    ...
    public String addAllR(List<Restaurant> restaurants){
